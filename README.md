...
**배경음악**도 여기서 고릅니다. 저작권 없는 음원을 **`public/bgm/`** 폴더에 넣어두면
목록에 나옵니다. **[▶︎ 들어보기]** 로 확인하고, **[🎲 무작위]** 를 누르면 영상마다
다른 곡이 깔립니다(같은 곡이 연달아 나오지 않게 지금 곡은 빼고 고릅니다).

- 음량은 **아주 작게 / 보통 / 조금 크게** 중에 고릅니다
- **말하는 동안에는 음악이 자동으로 낮아집니다** — 목소리를 가리지 않습니다
- 곡이 영상보다 짧으면 이어 붙이고, 길면 잘라냅니다
- 녹음이 아직 없어도 음악만 깔아서 들어볼 수 있습니다

> ⚠️ **음원을 `public/audio/` 에 넣지 마세요.** 거기는 합친 내레이션이 들어가는
> 작업 폴더라 **[전부 지우고 처음부터]** 를 누르면 통째로 비워집니다 — 음악이 다 지워집니다.
> 깃허브에 올리실 때도 `public/bgm/` 폴더로 올려주세요.
